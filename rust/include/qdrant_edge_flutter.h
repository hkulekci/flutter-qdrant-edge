 ...
 */
typedef struct QeDenseHandle QeDenseHandle;
#endif
 ...
 */
struct QeDenseHandle *qe_dense_create(const char *model_dir);
#endif
 ...
 */
void qe_dense_destroy(struct QeDenseHandle *handle);
#endif
 ...
 */
char *qe_dense_embed(struct QeDenseHandle *handle, const char *text);
#endif
